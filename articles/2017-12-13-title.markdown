...
const testSamples = [
  { input: null, expectedResult: null, description: 'should return null when receiving null' },
  { input: undefined, expectedResult: null, description: 'should return null when receiving undefined' },
