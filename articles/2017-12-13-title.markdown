...
In this case, the numbers were pretty similar. But Mocha, with more stars on GitHub and around three times more downloads on NPM during 2017, looks like a winner. We will probably be supported by a great community and a lot of resources if we choose Mocha. So let's focus on configuring it in our project.
