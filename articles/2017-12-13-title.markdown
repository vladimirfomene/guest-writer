...
One of the most important topics in this article is about tests. Developing high quality code without automated tests is impossible. That is, we could write code that executes flawlessly without writing a single line of automated tests. However, this code would still not be considered as having high standards.
...
Cool, we now know what type of tests we will write. What is still uncovered is what libraries will we use to write this tests.
